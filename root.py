...
label1 = Label(root ,
               text = "HEY USER WELCOME TO MONEY COUNTER APPLICATION" , 
               bg = 'light blue')
...
def topwin() :
    top = Toplevel()
    top.title("Denominations Calculations")
    ...
    btn = Button(top , text="calculate" ,command=calculator , bg ='white' , fg='brown' )
